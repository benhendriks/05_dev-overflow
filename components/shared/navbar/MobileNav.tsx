      ...
      >
        <Link href="/" className="flex items-center gap-1">
          <Image
            ...
            alt="DevFlow"
          />
          <p className="h2-bold font-spaceGrotesk text-dark100_light900"></p>
        </Link>
        <div>
          <SheetClose asChild>
            <NavContent />
          ...
          <SignedOut>
            <div className="flex flex-col gap-3 ">
              ...
              <SheetClose asChild>
                <Link href="/sign-up">
                  <Button className="small-medium light-border-2 btn-tertiary min-h-[41] w-full rounded-lg px-4 py-3 shadow-none text-dark400_light900">
                    SignUp
                  </Button>
                </Link>
              </SheetClose>
